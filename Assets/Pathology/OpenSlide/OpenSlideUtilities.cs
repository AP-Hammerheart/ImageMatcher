...
//public class OpenSlideUtilities : MonoBehaviour
//{
...
//            bytes = CreatePNGFormat( buffer, w, h );
...
//    static byte[] CreatePNGFormat( IntPtr pixels, int width, int height ) {

//        Texture2D tex = Texture2D.CreateExternalTexture( width, height, TextureFormat.ARGB32, false, false, pixels );
//        byte[] b = tex.GetRawTextureData();
//        return b;
//    }
